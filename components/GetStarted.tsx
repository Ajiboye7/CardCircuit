...
const GetStarted = () => {
  return (
    <section className=" mx-5 md:mx-10 lg:mx-20 ">
        <div className="flex flex-col gap-8 items-center justify-center max-w-[1440px] mx-auto min-h-[600px] bg-fontColor rounded-3xl p-5 sm:p-14 relative top-64">
      ...
      <p className="text-GetStartedTextFonts text-2xl sm:text-2xl lg:text-3xl font-semibold leading-slightly-loose">Ready to revolutionize how you manage your money? Take the leap towards effortless money management with CardCircuit. Join us now and experience the future of centralized finance.</p>
